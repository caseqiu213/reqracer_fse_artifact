...
/// Print the table of all modules
    ...
    foreach ($modules as $module) {
        ...
        $delete = "<a href=\"modules.php?delete=$module->name&amp;sesskey=".sesskey()."&amp;_racetrkrnonce=".$_REQUEST['_racetrkrnonce']."\">$strdelete</a>";
        ...
        if ($count>0) {
            $countlink = "<a href=\"{$CFG->wwwroot}/course/search.php?modulelist=$module->name" .
                "&amp;sesskey=".sesskey()."&amp;_racetrkrnonce=".$_REQUEST['_racetrkrnonce']."\" title=\"$strshowmodulecourse\">$count</a>";
        } else if ($count < 0) {
        ...
        if ($missing) {
            ...
            $visible = "<a href=\"modules.php?hide=$module->name&amp;sesskey=".sesskey()."&amp;_racetrkrnonce=".$_REQUEST['_racetrkrnonce']."\" title=\"$strhide\">".
                       "<img src=\"" . $OUTPUT->pix_url('i/hide') . "\" class=\"icon\" alt=\"$strhide\" /></a>";
            $class   = '';
        } else {
            $visible = "<a href=\"modules.php?show=$module->name&amp;sesskey=".sesskey()."&amp;_racetrkrnonce=".$_REQUEST['_racetrkrnonce']."\" title=\"$strshow\">".

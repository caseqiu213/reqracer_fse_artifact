...
/**
	...
	*/
	...
	public function getEditToken( $salt = '', $request = null ) {
		$record = 0;
		if ($record){
			return $this->getEditTokenAtTimestamp($salt, $request ?: $this->getRequest(), wfTimestamp());
		}
		else{
			if ( $request == null ) {
				$request = $this->getRequest();
	...
	public function matchEditToken( $val, $salt = '', $request = null, $maxage = null ) {
		...
		$sessionToken = $this->getEditTokenAtTimestamp( $salt, $request ?: $this->getRequest(), $timestamp );
